...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\freshmarket\freshmarketprices_auto"
output_folder = r"C:\zolpo\freshmarket\freshmarketprices_auto_json"
...
schedule.every().day.at("15:36").do(convert_gz_to_json)
