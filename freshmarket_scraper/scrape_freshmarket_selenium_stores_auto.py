...
OUTPUT_PATH = "valid_links_stores_freshmarket.txt"  # שם קובץ מעודכן ל-Yohananof
USER_NAME = "freshmarket"
PASSWORD = "freshmarket"  # בהנחה שאין סיסמה שונה, אם כן תגיד לי ואעדכן
...
# תזמון יומי
schedule.every().day.at("15:38").do(job)
