...
LINKS_FILE = "valid_links_stores_freshmarket.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\freshmarket\freshmarket_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("15:39").do(download_all_stores)
