...
LINKS_FILE = "valid_links_stores_keshettaamim.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\keshettaamim\keshettaamim_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("11:19").do(download_all_stores)
