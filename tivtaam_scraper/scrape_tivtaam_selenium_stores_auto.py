...
OUTPUT_PATH = "valid_links_stores_tivtaam.txt"  # שם קובץ מעודכן ל-politzer
USER_NAME = "TivTaam"
PASSWORD = "TivTaam"  # בהנחה שאין סיסמה שונה, אם כן תגיד לי ואעדכן
...
# תזמון יומי
schedule.every().day.at("09:52").do(job)
