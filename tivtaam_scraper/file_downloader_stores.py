...
LINKS_FILE = "valid_links_stores_tivtaam.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\tivtaam\tivtaam_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("09:54").do(download_all_stores)
