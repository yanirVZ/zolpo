...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\supercofix\supercofixprices_auto"
output_folder = r"C:\zolpo\supercofix\supercofixprices_auto_json"
...
schedule.every().day.at("16:15").do(convert_gz_to_json)
