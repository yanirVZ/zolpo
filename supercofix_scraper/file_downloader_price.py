...
LINKS_FILE = "valid_links_supercofix.txt"  # הקובץ שהפקנו בסקרייפר
DOWNLOAD_FOLDER = r"C:\zolpo\supercofix\supercofixprices_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("16:13").do(job)
