...
LINKS_FILE = "valid_links_stores_supercofix.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\supercofix\supercofix_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("16:21").do(download_all_stores)
