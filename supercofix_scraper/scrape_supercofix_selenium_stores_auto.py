...
OUTPUT_PATH = "valid_links_stores_supercofix.txt"  # שם קובץ מעודכן ל-politzer
USER_NAME = "SuperCofixApp"
PASSWORD = "SuperCofixApp"  # בהנחה שאין סיסמה שונה, אם כן תגיד לי ואעדכן
