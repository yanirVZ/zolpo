...
LINKS_FILE = "valid_links_stores_yohananof.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\yohananof\yohananof_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("12:25").do(download_all_stores)
