...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\yohananof\yohananofprices_auto"
output_folder = r"C:\zolpo\yohananof\yohananofprices_auto_json"
...
schedule.every().day.at("11:57").do(convert_gz_to_json)
