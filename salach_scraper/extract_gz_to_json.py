...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\salachdabach\salachdabachprices_auto"
output_folder = r"C:\zolpo\salachdabach\salachdabachprices_auto_json"
...
schedule.every().day.at("10:55").do(convert_gz_to_json)
