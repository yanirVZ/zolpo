...
LINKS_FILE = "valid_links_stores_salachdabach.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\salachdabach\salachdabach_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("11:01").do(download_all_stores)
