...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\politzer\politzerprices_auto"
output_folder = r"C:\zolpo\politzer\politzerprices_auto_json"
...
schedule.every().day.at("13:55").do(convert_gz_to_json)
