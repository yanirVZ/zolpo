...
LINKS_FILE = "valid_links_stores_politzer.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\politzer\politzer_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("14:31").do(download_all_stores)
