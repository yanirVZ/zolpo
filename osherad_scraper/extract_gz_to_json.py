...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\osherad\osheradprices_auto"
output_folder = r"C:\zolpo\osherad\osheradprices_auto_json"
...
schedule.every().day.at("13:23").do(convert_gz_to_json)
