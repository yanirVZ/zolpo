...
OUTPUT_PATH = "valid_links_stores_osherad.txt"  # שם קובץ מעודכן ל-Yohananof
USER_NAME = "osherad"
PASSWORD = "osherad"  # בהנחה שאין סיסמה שונה, אם כן תגיד לי ואעדכן
...
# תזמון יומי
schedule.every().day.at("13:27").do(job)
