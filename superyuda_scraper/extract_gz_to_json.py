...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\superyuda\superyudaprices_auto"
output_folder = r"C:\zolpo\superyuda\superyudaprices_auto_json"
...
schedule.every().day.at("17:26").do(convert_gz_to_json)
