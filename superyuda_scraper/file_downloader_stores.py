...
LINKS_FILE = "valid_links_stores_superyuda.txt"  # לינקים של יוחננוף
DOWNLOAD_FOLDER = r"C:\zolpo\superyuda\superyuda_prices_stores_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("17:34").do(download_all_stores)
