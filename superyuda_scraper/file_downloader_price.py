...
LINKS_FILE = "valid_links_superyuda.txt"  # הקובץ שהפקנו בסקרייפר
DOWNLOAD_FOLDER = r"C:\zolpo\superyuda\superyudaprices_auto"  # תיקיית הורדה ליוחננוף
...
schedule.every().day.at("17:24").do(job)
