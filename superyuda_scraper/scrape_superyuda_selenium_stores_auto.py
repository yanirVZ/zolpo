...
OUTPUT_PATH = "valid_links_stores_superyuda.txt"  # שם קובץ יעד
USER_NAME = "yuda_ho"
PASSWORD = "Yud@147"  # עדכן במידת הצורך
...
# תזמון יומי (עדכן שעה לפי הצורך)
schedule.every().day.at("17:32").do(job)
