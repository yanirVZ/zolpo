...
def load_store_mapping():
    mapping_file = r"C:\Zolpo\superyuda\superyuda_prices_stores_auto\flat_store_mapping_superyuda.json"
    try:
        with open(mapping_file, 'r', encoding='utf-8') as f:
            store_mapping = json.load(f)
        print(f"📦 נטען מיפוי של {len(store_mapping)} סניפים מקובץ flat_store_mapping_superyuda.json")
...
def update_price_files():
    ...
    input_folder = r"C:\Zolpo\superyuda\superyudaprices_auto_json"
    output_folder = r"C:\Zolpo\superyuda\superyudaprices_auto_json_updated"
    report_folder = r"C:\Zolpo\superyuda\reports"
...
# תזמון יומי
schedule.every().day.at("17:56").do(update_price_files)
