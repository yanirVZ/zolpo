...
LINKS_FILE = "valid_links_stores_auto.txt"
DOWNLOAD_FOLDER = r"C:\zolpo\ramilevi\rami_levi_prices_stores_auto"
...
# תזמון משימה יומית ל־07:00
schedule.every().day.at("10:49").do(download_all_stores)

if __name__ == "__main__":
    print("⏳ ממתין ל־07:00 לביצוע הורדת קבצי Stores...")
    while True:
        try:
