...
OUTPUT_PATH = "valid_links_stores_auto.txt"
USER_NAME = "RamiLevi"
PASSWORD = "RamiLevi"  # אם הסיסמה היא כמו שם המשתמש – אחרת תעדכן פה
...
# משימה מתוזמנת
def job():
    print("🕖 בוקר טוב! מתחיל סקרייפינג ב־07:00 בדיוק...")
    scrape_stores()
...
if __name__ == "__main__":
    print("⏳ ממתין ל־07:00 להפעלת הסקרייפינג...")
    while True:
        try:
