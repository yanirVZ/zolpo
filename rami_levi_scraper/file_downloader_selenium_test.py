...
LINKS_FILE = "valid_links_updated_auto.txt"
DOWNLOAD_FOLDER = r"C:\zolpo\ramilevi\rami_levi_prices_auto"
...
# הגדרת משימה מתוזמנת ל־7:00 בבוקר
def job():
    print("🌅 התחלת הורדה אוטומטית ב-07:00...")
    download_all()

# תזמון הרצה כל יום בשעה 7:00
schedule.every().day.at("10:32").do(job)

# הרצה תמידית ברקע
if __name__ == "__main__":
    print("⏳ ממתין לשעה 07:00 לביצוע הורדה יומית...")
    while True:
        try:
