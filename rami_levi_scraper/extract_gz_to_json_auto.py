...
# נתיבי קלט ופלט
input_folder = r"C:\zolpo\ramilevi\rami_levi_prices_auto"
output_folder = r"C:\zolpo\ramilevi\rami_levi_auto_json"
...
# תזמון משימה יומית לשעה 7:00 בבוקר
schedule.every().day.at("10:36").do(convert_gz_to_json)

# הרצה תמידית של הבדיקה
if __name__ == "__main__":
    print("⏳ ממתין ל־07:00 לביצוע המרה יומית מ־GZ ל־JSON...")
    while True:
        try:
